...
interface AddLocationProps { onDataUpdate?(lat:number, lng:number):void }
...
export class AddLocation extends React.Component<AddLocationProps, AddLocationState>
{
    ...
    {
        super();
        this.state = { selectedLocation:new google.maps.LatLng(59.8346001,10.436568699999953), feedbackMessage:null, searchval:""}
        this.map = null;
        this.marker = null; 
    }
