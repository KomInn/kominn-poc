...
class TextField extends React.Component<InputFieldProps, InputFieldState>
{
    ...
    render() {
        ...
        return <div className="form-group"><label className={`${errorClass}`}>{this.props.Label}</label>
        ...
        return (<div><div className="row"> 
            ...
            <div className="row">
                <div className="col-xs-12 col-sm-4 col-md-4 ">
                    ...
                    <TextField Label="Tittel *" OnChangeHandler={this.changeEvent.bind(this) } Value={this.state.suggestion.Title} Name="Title" Placeholder="Beskriv ideen med én setning" Validate={this.state.validate} />
