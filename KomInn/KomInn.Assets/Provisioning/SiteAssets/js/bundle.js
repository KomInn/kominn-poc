...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewSuggestionForm_1 = __webpack_require__(3);
	var AllSuggestions_1 = __webpack_require__(11);
	var ViewSuggestion_1 = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPTools_1 = __webpack_require__(10);
	var TextArea = (function (_super) {
	    ...
	    TextArea.prototype.render = function () {
	        ...
	        return (React.createElement("div", { className: "form-group" },
	            React.createElement("label", { className: markErrorClass }, this.props.Label),
	            React.createElement("textarea", { type: "text", className: "form-control", onChange: this.handleChange.bind(this), value: this.props.Value, placeholder: this.props.Placeholder })));
	    };
	    return TextArea;
	}(React.Component));
	var TextField = (function (_super) {
	    ...
	    TextField.prototype.renderError = function () {
	        if (!this.state.isValid && this.props.Value.length > 0) {
	            return React.createElement("label", { className: "label-error" },
	                "Feltet m\u00E5 ha ",
	                this.props.ForceLength,
	                " tegn.");
	        }
	    };
	    ...
	    TextField.prototype.render = function () {
	        ...
	        return React.createElement("div", { className: "form-group" },
	            React.createElement("label", { className: "" + errorClass }, this.props.Label),
	            React.createElement("input", { type: "text", className: "form-control", onChange: this.handleChange.bind(this), value: this.props.Value, placeholder: this.props.Placeholder, onBlur: this.forceLengthCheck.bind(this) }));
	    };
	    return TextField;
	}(React.Component));
	var SPTaxonomyField = (function (_super) {
	    ...
	    function SPTaxonomyField() {
	        ...
	        _this.state = { terms: new Array(), valueInvalid: false, text: "" };
	        return _this;
	    }
	    ...
	    SPTaxonomyField.prototype.render = function () {
	        return React.createElement("div", { className: "form-group" },
	            ...
	            React.createElement("div", { id: "bloodhound" },
	                React.createElement("input", { className: "typeahead form-control", type: "text" })),
	    ...
	    SPTaxonomyField.prototype.initTypeahead = function () {
	        ...
	        var options = { highlight: true, hint: false, minLength: 0 };
	...
	var NewSuggestionForm = (function (_super) {
	    ...
	    function NewSuggestionForm() {
	        ...
	        _this.state = { suggestion: suggestion, submitted: false, validate: false, postalCodeInvalid: false, postalCodeText: "", submitValidationFailed: false, submitFailed: false };
	        return _this;
	    }
	    ...
	    NewSuggestionForm.prototype.renderSubmitValidationFailed = function () {
	        if (this.state.submitValidationFailed)
	            return React.createElement("label", { style: { color: 'red' } },
	                React.createElement("br", null),
	                "Vennligst fyll ut feltene i r\u00F8dt.");
	    };
	    NewSuggestionForm.prototype.rendersubmitFailed = function () {
	        if (this.state.submitFailed)
	            return React.createElement("label", { style: { color: 'red' } },
	                React.createElement("br", null),
	                " En feil oppstod ved innsending av skjemaet.Pr\u00F8v p\u00E5 nytt senere.");
	    };
	    NewSuggestionForm.prototype.render = function () {
	        if (this.state.submitted)
	            return React.createElement(ThankYouPage, null);
	        if (this.state.submitting)
	            return React.createElement("h3", null, "Sender...");
	        return (React.createElement("div", null,
	            React.createElement("div", { className: "row" },
	                React.createElement("div", { className: "col-xs-12" },
	                    React.createElement("h1", null, "Nytt forslag"),
	                    React.createElement("p", null, "Tekst her..."))),
	            React.createElement("div", { className: "row" },
	                React.createElement("div", { className: "col-xs-12 col-sm-4 col-md-4 " },
	                    React.createElement(TextField, { Label: "Postnummer", OnChangeHandler: this.postnrLookup.bind(this), Value: this.state.postalCodeText, Name: "Postnummer", ForceLength: 4 }),
	                    this.renderPostalCodeError(),
	                    React.createElement(TextField, { Label: "Tittel *", OnChangeHandler: this.changeEvent.bind(this), Value: this.state.suggestion.Title, Name: "Title", Placeholder: "Beskriv ideen med én setning", Validate: this.state.validate }),
	                    React.createElement(TextArea, { Label: "Utfordring *", OnChangeHandler: this.changeEvent.bind(this), Value: this.state.suggestion.Utfordring, Name: "Utfordring", Placeholder: "Fortell om utfordringen", Validate: this.state.validate }),
	                    React.createElement(TextArea, { Label: "Forslag til løsning *", OnChangeHandler: this.changeEvent.bind(this), Value: this.state.suggestion.ForslagTilLosning, Name: "ForslagTilLosning", Validate: this.state.validate }),
	                    React.createElement(TextArea, { Label: "Nyttig for andre? *", OnChangeHandler: this.changeEvent.bind(this), Value: this.state.suggestion.NyttigForAndre, Name: "NyttigForAndre", Validate: this.state.validate }),
	                    React.createElement(SPTaxonomyField, { Label: "Type nytte / nytteverdi", Value: "", Name: "ForslagType", Termset: "ForslagType", LCID: 1033, TaxonomySelectedHandler: this.typeUtfordringSelectedHandler.bind(this) }),
	                    React.createElement("input", { type: "button", onClick: this.submitForm.bind(this), value: "Send inn" }),
	                    this.renderSubmitValidationFailed(),
	                    this.rendersubmitFailed()),
	                React.createElement("div", { className: "col-xs-12 col-sm-4  col-md-4 " },
	                    React.createElement(TextField, { Label: "Navn", Value: this.state.suggestion.Navn.DisplayName, Name: "Navn", Locked: true }),
	                    React.createElement(TextField, { Label: "Adresse", OnChangeHandler: this.changeEvent.bind(this), Value: this.state.suggestion.Adresse, Name: "Adresse" }),
	                    React.createElement(TextField, { Label: "Mailadresse", OnChangeHandler: this.changeEvent.bind(this), Value: this.state.suggestion.Epostadresse, Name: "Epostadresse" }),
	                    React.createElement(TextField, { Label: "Telefon", OnChangeHandler: this.changeEvent.bind(this), Value: this.state.suggestion.Telefon, Name: "Telefon" })))));
	    };
	...
	var ThankYouPage = (function (_super) {
	    ...
	    ThankYouPage.prototype.render = function () {
	        return React.createElement("div", { className: "row" },
	            React.createElement("div", { className: "col-xs-12" },
	                React.createElement("h1", null, "Takk for ditt bidrag!"),
	                React.createElement("p", null, "Du h\u00F8rer fra oss snarlig."),
	                React.createElement("a", { href: _spPageContextInfo.webAbsoluteUrl + "/SitePages/Home.aspx" }, "Tilbake til oversikten")));
	    };
	    return ThankYouPage;
	}(React.Component));
...
/***/ function(module, exports) {
	...
	*/
	...
	var SortTypes;
	(function (SortTypes) {
	    SortTypes[SortTypes["Newest"] = 0] = "Newest";
	    SortTypes[SortTypes["Oldest"] = 1] = "Oldest";
	    SortTypes[SortTypes["Comments"] = 2] = "Comments";
	    SortTypes[SortTypes["Likes"] = 3] = "Likes";
	})(SortTypes = exports.SortTypes || (exports.SortTypes = {}));
	;
	var SuggestionViewDisplayMode;
	(function (SuggestionViewDisplayMode) {
	    SuggestionViewDisplayMode[SuggestionViewDisplayMode["Brief"] = 0] = "Brief";
	    SuggestionViewDisplayMode[SuggestionViewDisplayMode["Detailed"] = 1] = "Detailed";
	})(SuggestionViewDisplayMode = exports.SuggestionViewDisplayMode || (exports.SuggestionViewDisplayMode = {}));
	;
	var SuggestionType;
	...
	var Suggestion = (function () {
	    ...
	    Suggestion.prototype.findProperty = function (property, props) {
	        for (var i = 0; i < props.length; i++) {
	    ...
	    Suggestion.prototype.PopulateFromUserProfile = function () {
	        ...
	        UserProfile.GetMyProperties()
	            ...
	            _this.Adresse = _this.findProperty("Office", props);
	            _this.Avdeling = _this.findProperty("SPS-JobTitle", props);
	            _this.Epostadresse = _this.findProperty("WorkEmail", props);
	            _this.Telefon = _this.findProperty("CellPhone", props);
	            _this.Virksomhet = _this.findProperty("Department", props);
	            ...
	            UserProfile.GetMyProperties()
	                ...
	                var manager = _this.findProperty("Manager", props);
	...
	*/
	...
	var ShowAllButton = (function (_super) {
	    ...
	    function ShowAllButton() {
	        var _this = _super.call(this) || this;
	        _this.state = { DisplayMode: SPTools_1.SuggestionViewDisplayMode.Brief };
	        return _this;
	    }
	    ...
	    ShowAllButton.prototype.render = function () {
	        ...
	        return (React.createElement("div", { className: "text-right button" },
	            React.createElement("div", { className: "btn-lg btn btn-success", onClick: this.buttonClicked.bind(this) }, buttonText)));
	    };
	...
	var AllSuggestions = (function (_super) {
	    ...
	    function AllSuggestions() {
	        var _this = _super.call(this) || this;
	        _this.state = { DisplayModeAll: SPTools_1.SuggestionViewDisplayMode.Brief };
	        return _this;
	    }
	        ...
	        return (React.createElement("div", null,
	            React.createElement("div", { className: "row" },
	                React.createElement("div", { className: "col-xs-2" },
	                    React.createElement("h1", null, "KomInn")),
	                React.createElement("div", { className: "col-xs-4" },
	                    React.createElement(NewSuggestionButton, null)),
	                React.createElement("div", { className: "col-xs-6" })),
	            React.createElement(SuggestionList, { Title: "Mottatte forslag", InitialDisplayMode: SPTools_1.SuggestionViewDisplayMode.Brief, Type: SPTools_1.SuggestionType.Submitted }),
	...
	var NewSuggestionButton = (function (_super) {
	    __extends(NewSuggestionButton, _super);
	    function NewSuggestionButton() {
	        return _super.apply(this, arguments) || this;
	    }
	    NewSuggestionButton.prototype.redirectToNewSuggestion = function () {
	...
	var SuggestionList = (function (_super) {
	    __extends(SuggestionList, _super);
	    function SuggestionList() {
	        var _this = _super.call(this) || this;
	        _this.id = SP.Guid.newGuid().toString();
	        _this.state = {
	    ...
	    SuggestionList.prototype.renderIndicators = function () {
	        ...
	        if (this.state.suggestions.length <= 3)
	            return React.createElement("div", null);
	        return (React.createElement("div", { className: "carousel-indicators-wrap" },
	            React.createElement("a", { className: "carousel-control left glyphicon glyphicon-chevron-left ", href: '#' + this.id, "data-slide": "prev" }),
	            React.createElement("ol", { className: "carousel-indicators" }, this.state.partitions.map(function (item, index) {
	    ...
	    SuggestionList.prototype.render = function () {
	        ...
	        return (React.createElement("div", null,
	            React.createElement("div", { className: "row" },
	                ...
	                React.createElement("div", { className: "col-xs-6" },
	                    React.createElement(ShowAllButton, { DisplayMode: this.state.DisplayMode, OnClickHandler: this.changeDisplayMode.bind(this) }))),
	            React.createElement("div", { className: "row" },
	                React.createElement("div", { className: "col-xs-12" },
	                    this.renderFilters(),
	                    React.createElement("div", { id: this.id, className: "carousel slide", "data-interval": "false" },
	                        React.createElement("div", { className: "carousel-inner" }, this.state.partitions.map(function (item, index) {
	                            if (_this.detailedMode()) {
	    ...
	    SuggestionList.prototype.renderFilters = function () {
	        if (!this.detailedMode())
	            return (React.createElement("span", null));
	        return (React.createElement("div", { className: "row" },
	            React.createElement("div", { className: "filters form-group" },
	                React.createElement("div", { className: "col-xs-4" },
	                    React.createElement("span", { className: "glyphicon glyphicon-filter" }),
	                    React.createElement("strong", null, "Filtrer "),
	                    React.createElement("select", { className: "form-control", onChange: this.filterChange.bind(this) },
	                ...
	                React.createElement("div", { className: "col-xs-4" },
	                    ...
	                    React.createElement("strong", null, "Sorter "),
	                    React.createElement("select", { className: "form-control", onChange: this.sortChange.bind(this) },
	                        React.createElement("option", { value: SPTools_1.SortTypes.Newest.toString(), selected: true }, "Nyeste"),
	                        React.createElement("option", { value: SPTools_1.SortTypes.Oldest.toString() }, "Eldste"),
	                        React.createElement("option", { value: SPTools_1.SortTypes.Comments.toString() }, "Kommentarer"),
	                        React.createElement("option", { value: SPTools_1.SortTypes.Likes.toString() }, "Likerklikk"))))));
	    };
	...
	var CarouselViewItem = (function (_super) {
	    ...
	    CarouselViewItem.prototype.render = function () {
	        ...
	        return (React.createElement("div", { className: "item " + active },
	            React.createElement("div", { className: "row" }, this.props.suggestions.map(function (item, index) {
	                return React.createElement(CarouselItem, { suggestion: item, DisplayMode: _this.props.DisplayMode, Fullwidth: _this.props.Fullwidth });
	            }))));
	    };
	...
	var CarouselItem = (function (_super) {
	    ...
	    CarouselItem.prototype.renderTags = function () {
	        if (this.props.suggestion.ForslagType.Id.length <= 0)
	            return;
	        return (React.createElement("span", { className: "iconspace" },
	            React.createElement("span", { className: "icon glyphicon glyphicon-tag" }),
	            this.props.suggestion.ForslagType.Title));
	    };
	    CarouselItem.prototype.renderLikes = function () {
	        if (this.props.suggestion.Likes <= 0)
	            return;
	        return (React.createElement("span", { className: "iconspace" },
	            React.createElement("span", { className: "icon glyphicon glyphicon-thumbs-up" }),
	            this.props.suggestion.Likes));
	    };
	    CarouselItem.prototype.renderComments = function () {
	        if (this.props.suggestion.AntallKommentarer <= 0 || this.props.suggestion.AntallKommentarer == undefined)
	            return;
	        return (React.createElement("span", { className: "iconspace" },
	            React.createElement("span", { className: "icon glyphicon glyphicon-comment iconspace" }),
	            this.props.suggestion.AntallKommentarer));
	    };
	    ...
	    CarouselItem.prototype.render = function () {
	        ...
	        return (React.createElement("div", { className: "col-sm-4 col-md-4 col-lg-3 " + xsSize },
	            React.createElement("section", { className: "ki-shadow-box-item " + fullWidth, id: this.id, style: bgImgUrl },
	                React.createElement("article", { className: "carousel-item kiGradient clickable", onClick: this.redirect.bind(this) },
	                    React.createElement("header", null, this.props.suggestion.Utfordring),
	                    React.createElement("main", { className: "" },
	                        React.createElement("p", null, this.props.suggestion.ForslagTilLosning)),
	                    React.createElement("footer", null,
	                        this.renderLikes(),
	                        this.renderComments(),
	                        this.renderTags(),
	                        React.createElement("div", { className: "dateperson" },
	                            React.createElement("span", { className: "glyphicon glyphicon-calendar" }),
	                            this.props.suggestion.Created,
	                            React.createElement("span", { className: "glyphicon glyphicon-user iconspace" }),
	                            this.props.suggestion.Navn.DisplayName))))));
	    };
	    return CarouselItem;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewSuggestion = (function (_super) {
	    ...
	    function ViewSuggestion() {
	        var _this = _super.call(this) || this;
	        _this.state = { Suggestion: new SPTools_1.Suggestion() };
	        _this.self = { DisplayName: "", LoginName: "", Id: _spPageContextInfo.userId };
	        return _this;
	    }
	    ...
	    ViewSuggestion.prototype.render = function () {
	        if (this.state.Suggestion.Id == -1)
	            return React.createElement("div", null);
	        return (React.createElement("div", null,
	            React.createElement(SuggestionDataView, { Suggestion: this.state.Suggestion }),
	            React.createElement(SuggestionComments, { Suggestion: this.state.Suggestion })));
	    };
	    ...
	    SuggestionDataView.prototype.render = function () {
	        ...
	        return (React.createElement("div", { className: "row" },
	            React.createElement("div", { className: "col-xs-12 col-md-6" },
	                React.createElement(SuggestionDataHeader, { Text: "Forslag", Display: "" }),
	                React.createElement(SuggestionDataRow, { Text: "Forslagsstiller:", Display: this.props.Suggestion.Navn.DisplayName }),
	                React.createElement(SuggestionDataRow, { Text: "Kommune:", Display: this.props.Suggestion.Kommune }),
	                React.createElement(SuggestionDataRow, { Text: "Type:", Display: this.props.Suggestion.ForslagType.Title }),
	                React.createElement(SuggestionDataRow, { Text: "Utfordring:", Display: this.props.Suggestion.Utfordring }),
	                React.createElement(SuggestionDataRow, { Text: "Nyttig for andre?:", Display: this.props.Suggestion.NyttigForAndre }),
	                React.createElement(SuggestionDataRow, { Text: "Forslag til løsning:", Display: this.props.Suggestion.ForslagTilLosning }),
	                React.createElement("hr", null),
	                React.createElement(SuggestionDataViewFooter, { Suggestion: this.props.Suggestion })),
	...
	var SuggestionDataViewFooter = (function (_super) {
	    ...
	    function SuggestionDataViewFooter() {
	        var _this = _super.call(this) || this;
	        _this.state = { numberOfLikes: 0, processing: false, userLikesThis: false };
	        return _this;
	    }
	    ...
	    SuggestionDataViewFooter.prototype.renderLikes = function () {
	        ...
	        return React.createElement("div", { className: "col-xs-4 likes" },
	    ...
	    SuggestionDataViewFooter.prototype.renderTags = function () {
	        if (this.props.Suggestion.Tags.length <= 0)
	            return (React.createElement("div", null));
	        return (React.createElement("div", { className: "col-xs-4 tags" },
	            React.createElement("ul", null, this.props.Suggestion.Tags.map(function (value, index) {
	    ...
	    SuggestionDataViewFooter.prototype.renderLikebutton = function () {
	        ...
	        if (this.state.processing)
	            text = "Vent litt...";
	        return (React.createElement("div", { className: "likebutton col-xs-4" },
	            React.createElement("div", { className: "btn-xs btn-like " + btnType, onClick: this.handleLikeClick.bind(this) },
	                React.createElement("span", { className: "glyphicon glyphicon-thumbs-up" }),
	                text)));
	    };
	    SuggestionDataViewFooter.prototype.render = function () {
	        return (React.createElement("div", { className: "row" },
	            React.createElement("div", { className: "dataviewfooter" },
	...
	var SuggestionDataRow = (function (_super) {
	    ...
	    SuggestionDataRow.prototype.render = function () {
	        return (React.createElement("div", { className: "row" },
	            React.createElement("div", { className: "col-xs-12" },
	                React.createElement("label", null, this.props.Text),
	                " ",
	                this.props.Display)));
	    };
	...
	var SuggestionComments = (function (_super) {
	    ...
	    function SuggestionComments() {
	        var _this = _super.call(this) || this;
	        _this.state = { Comments: new Array() };
	        return _this;
	    }
	    ...
	    SuggestionComments.prototype.render = function () {
	        return (React.createElement("div", { className: "row" },
	            React.createElement("div", { className: "col-xs-12 col-md-6" },
	                React.createElement("hr", null),
	                React.createElement(NewCommentBox, { Suggestion: this.props.Suggestion, NewCommentAddedHandler: this.newCommentAddedHandler.bind(this) }),
	...
	var NewCommentBox = (function (_super) {
	    ...
	    function NewCommentBox() {
	        var _this = _super.call(this) || this;
	        _this.state = { Comment: { Text: "" }, ShowNewComment: false, Sending: false };
	        return _this;
	    }
	    ...
	    NewCommentBox.prototype.render = function () {
	        if (this.state.Sending)
	            return React.createElement("div", { className: "row" },
	                React.createElement("div", { className: "col-xs-12" },
	                    React.createElement("label", null, "Vennligst vent...")));
	        if (!this.state.ShowNewComment)
	            return (React.createElement("div", { className: "row newcomment" },
	                React.createElement("div", { className: "col-xs-12" },
	                    React.createElement("div", { className: "btn-xs btn-like btn-success btn-newcomment", onClick: this.handleShowNewComment.bind(this) }, "Ny kommentar"))));
	        return (React.createElement("div", { className: "newcomment" },
	            React.createElement("div", { className: "row" },
	                React.createElement("div", { className: "col-xs-12" },
	                    React.createElement("label", null, "Skriv kommentar"),
	                    React.createElement("textarea", { value: this.state.Comment.Text, onChange: this.handleTextChanged.bind(this) }))),
	            React.createElement("div", { className: "row" },
	                React.createElement("div", { className: "col-xs-12" },
	                    React.createElement("div", { className: "btn-xs btn-success btn-send", onClick: this.saveNewComment.bind(this) }, "Send")))));
	    };
	...
	var CommentsList = (function (_super) {
	    ...
	    CommentsList.prototype.render = function () {
	        ...
	        return (React.createElement("div", { className: "row comments" },
	            React.createElement("div", { className: "col-xs-12" }, this.props.Comments.map((function (item, index) {
	...
	var CommentItem = (function (_super) {
	    ...
	    CommentItem.prototype.render = function () {
	        return (React.createElement("div", { className: "comment" },
	            React.createElement("div", { className: "row" },
	                React.createElement("div", { className: "col-xs-2" }, this.RenderProfileImage()),
	                React.createElement("div", { className: "col-xs-10" },
	                    React.createElement("h4", null, this.props.comment.Person.DisplayName),
	                    React.createElement("div", null, this.props.comment.Text.split("\n").map(function (item) {
	                        return (React.createElement("span", null,
	                            item,
	                            React.createElement("br", null)));
	                    })),
